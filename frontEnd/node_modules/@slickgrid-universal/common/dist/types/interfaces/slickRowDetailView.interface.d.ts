...
export interface SlickRowDetailView {
    ...
    onRowOutOfViewportRange?: SlickEvent<{
        item: any;
        rowId: number | string;
        rowIndex: number;
        expandedRows: Array<number | string>;
...
//# sourceMappingURL=slickRowDetailView.interface.d.ts.map