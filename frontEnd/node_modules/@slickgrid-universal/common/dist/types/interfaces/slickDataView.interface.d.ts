import { Grouping, ItemMetadata, PagingInfo, SlickEvent, SlickGrid } from './index';
export interface SlickDataView {
     ...
     */
    setSelectedIds(selectedIds: Array<number | string>, options?: {
...
//# sourceMappingURL=slickDataView.interface.d.ts.map