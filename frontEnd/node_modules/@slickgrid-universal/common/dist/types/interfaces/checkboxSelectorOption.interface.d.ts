...
export interface CheckboxSelectorOption {
     ...
     */
    onSelectAllToggleStart?: (e: Event | null, args: {
        previousSelectedRows: number[];
        caller: 'click.selectAll' | 'click.unselectAll';
    }) => void;
    /** Optional callback method to be executed when the "Select All" toggled action is completed. */
    onSelectAllToggleEnd?: (e: Event | null, args: {
        rows: number[];
        previousSelectedRows: number[];
        caller: 'click.selectAll' | 'click.unselectAll';
    }) => void;
