import { GridSize, ResizerOption, SlickEvent, SlickEventData, SlickGrid } from './index';
/**
...
export interface SlickResizer {
    ...
    onGridAfterResize: SlickEvent<{
        grid: SlickGrid;
        dimensions: GridSize;
    }>;
    /** triggered when rows are being moved */
    onGridBeforeResize: SlickEvent<{
        grid: SlickGrid;
    }>;
}
//# sourceMappingURL=slickResizer.interface.d.ts.map