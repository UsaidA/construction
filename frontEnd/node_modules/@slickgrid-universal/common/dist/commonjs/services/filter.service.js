...
class FilterService {
    ...
    customLocalFilter(item, args) {
        ...
        if (isGridWithTreeData && this._gridOptions && this._gridOptions.treeDataOptions) {
            ...
            const collapsedPropName = (_d = treeDataOptions.collapsedPropName) !== null && _d !== void 0 ? _d : constants_1.Constants.treeDataProperties.COLLAPSED_PROP;
            const parentPropName = (_f = treeDataOptions.parentPropName) !== null && _f !== void 0 ? _f : constants_1.Constants.treeDataProperties.PARENT_PROP;
    ...
    preFilterTreeData(inputItems, columnFilters) {
        ...
        const parentPropName = (_c = treeDataOptions === null || treeDataOptions === void 0 ? void 0 : treeDataOptions.parentPropName) !== null && _c !== void 0 ? _c : constants_1.Constants.treeDataProperties.PARENT_PROP;
        const hasChildrenPropName = (_d = treeDataOptions === null || treeDataOptions === void 0 ? void 0 : treeDataOptions.hasChildrenPropName) !== null && _d !== void 0 ? _d : constants_1.Constants.treeDataProperties.HAS_CHILDREN_PROP;
        ...
        if (Array.isArray(inputItems)) {
            ...
            for (const columnId of Object.keys(columnFilters)) {
                ...
                const columnDef = columnFilter.columnDef;
                const fieldType = (_s = (_r = (_q = columnDef === null || columnDef === void 0 ? void 0 : columnDef.filter) === null || _q === void 0 ? void 0 : _q.type) !== null && _r !== void 0 ? _r : columnDef === null || columnDef === void 0 ? void 0 : columnDef.type) !== null && _s !== void 0 ? _s : index_2.FieldType.string;
    ...
    emitFilterChanged(caller, isBeforeExecution = false) {
        ...
        if (caller === index_2.EmitterType.remote && ((_a = this._gridOptions) === null || _a === void 0 ? void 0 : _a.backendServiceApi)) {
            let currentFilters = [];
