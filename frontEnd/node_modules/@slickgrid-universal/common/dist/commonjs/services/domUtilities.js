...
exports.windowScrollPosition = exports.sanitizeTextByAvailableSanitizer = exports.sanitizeHtmlToText = exports.htmlEncodedStringWithPadding = exports.htmlEntityDecode = exports.htmlEncode = exports.findWidthOrDefault = exports.findFirstElementAttribute = exports.getSelectorStringFromElement = exports.getHtmlElementOffset = exports.getElementOffsetRelativeToParent = exports.emptyElement = exports.destroyObjectDomElementProps = exports.createDomElement = exports.calculateAvailableSpace = exports.buildSelectEditorOrFilterDomElement = void 0;
 ...
 */
function buildSelectEditorOrFilterDomElement(type, collection, columnDef, grid, isMultiSelect = false, translaterService, searchTerms) {
...
exports.buildSelectEditorOrFilterDomElement = buildSelectEditorOrFilterDomElement;
...
function createDomElement(tagName, elementOptions) {
    const elm = document.createElement(tagName);
    if (elementOptions) {
        Object.keys(elementOptions).forEach((elmOptionKey) => {
            const elmValue = elementOptions[elmOptionKey];
            if (typeof elmValue === 'object') {
                (0, utils_1.deepMerge)(elm[elmOptionKey], elmValue);
            }
            else {
