...
class PaginationService {
    ...
    refreshPagination(isPageNumberReset = false, triggerChangedEvent = true, triggerInitializedEvent = false) {
        ...
        if (triggerChangedEvent && !(0, lite_1.dequal)(previousPagination, this.getFullPagination())) {
        ...
        if (triggerInitializedEvent && !(0, lite_1.dequal)(previousPagination, this.getFullPagination())) {
