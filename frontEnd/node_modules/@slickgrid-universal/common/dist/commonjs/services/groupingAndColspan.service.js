...
exports.GroupingAndColspanService = void 0;
const domUtilities_1 = require("./domUtilities");
class GroupingAndColspanService {
    constructor(extensionUtility, pubSubService) {
    ...
    init(grid) {
        ...
        if (grid && this._gridOptions) {
            ...
            if (this._gridOptions.createPreHeaderPanel) {
                ...
                this._subscriptions.push(this.pubSubService.subscribe(`onColumnPickerColumnsChanged`, () => this.renderPreHeaderRowGroupingTitles()), this.pubSubService.subscribe('onHeaderMenuHideColumns', () => this.delayRenderPreHeaderRowGroupingTitles(0)), this.pubSubService.subscribe(`onGridMenuColumnsChanged`, () => this.renderPreHeaderRowGroupingTitles()), this.pubSubService.subscribe(`onGridMenuMenuClose`, () => this.renderPreHeaderRowGroupingTitles()));
    ...
    renderHeaderGroups(preHeaderPanel, start, end) {
        var _a, _b, _c;
        (0, domUtilities_1.emptyElement)(preHeaderPanel);
        ...
        for (let i = start; i < end; i++) {
            ...
            if (colDef) {
                if (lastColumnGroup === colDef.columnGroup && i > 0) {
                    ...
                    widthTotal = colDef.width || 0;
                    headerElm = (0, domUtilities_1.createDomElement)('div', {
                        className: `ui-state-default slick-header-column ${isFrozenGrid ? 'frozen' : ''}`,
                        style: { width: `${widthTotal - headerColumnWidthDiff}px` }
                    });
                    const spanColumnNameElm = (0, domUtilities_1.createDomElement)('span', { className: 'slick-column-name', textContent: colDef.columnGroup || '' });
