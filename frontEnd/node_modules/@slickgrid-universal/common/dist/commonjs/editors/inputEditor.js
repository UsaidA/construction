...
class InputEditor {
    ...
    init() {
        ...
        this._input = (0, domUtilities_1.createDomElement)('input', {
            ...
            autocomplete: 'none',
            placeholder: (_d = (_c = this.columnEditor) === null || _c === void 0 ? void 0 : _c.placeholder) !== null && _d !== void 0 ? _d : '',
            title: (_f = (_e = this.columnEditor) === null || _e === void 0 ? void 0 : _e.title) !== null && _f !== void 0 ? _f : '',
            className: `editor-text editor-${columnId}`,
        });
        this._input.setAttribute('aria-label', (_h = (_g = this.columnEditor) === null || _g === void 0 ? void 0 : _g.ariaLabel) !== null && _h !== void 0 ? _h : `${(0, utils_1.toSentenceCase)(columnId + '')} Input Editor`);
        ...
        this._bindEventService.bind(this._input, 'keydown', ((event) => {
            ...
            if (event.keyCode === keyCode_enum_1.KeyCode.LEFT || event.keyCode === keyCode_enum_1.KeyCode.RIGHT) {
    ...
    isValueChanged() {
        ...
        if (this.columnEditor && this.columnEditor.alwaysSaveOnEnterKey && lastKeyEvent === keyCode_enum_1.KeyCode.ENTER) {
            return true;
        }
    ...
    loadValue(item) {
        ...
        if (item && fieldName !== undefined && this._input) {
            ...
            const value = (isComplexObject) ? (0, utilities_1.getDescendantProperty)(item, fieldName) : (item.hasOwnProperty(fieldName) && item[fieldName] || '');
