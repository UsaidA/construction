...
class LongTextEditor {
    ...
    init() {
        ...
        this._textareaElm = (0, domUtilities_1.createDomElement)('textarea', {
            cols: (_u = (_t = this.editorOptions) === null || _t === void 0 ? void 0 : _t.cols) !== null && _u !== void 0 ? _u : 40,
            rows: (compositeEditorOptions && textAreaRows > 3) ? 3 : textAreaRows,
            placeholder: (_w = (_v = this.columnEditor) === null || _v === void 0 ? void 0 : _v.placeholder) !== null && _w !== void 0 ? _w : '',
            title: (_y = (_x = this.columnEditor) === null || _x === void 0 ? void 0 : _x.title) !== null && _y !== void 0 ? _y : '',
        });
        this._textareaElm.setAttribute('aria-label', (_0 = (_z = this.columnEditor) === null || _z === void 0 ? void 0 : _z.ariaLabel) !== null && _0 !== void 0 ? _0 : `${(0, utils_1.toSentenceCase)(columnId + '')} Text Editor`);
        ...
        if (!compositeEditorOptions) {
            const cancelBtnElm = (0, domUtilities_1.createDomElement)('button', { className: 'btn btn-cancel btn-default btn-xs', textContent: cancelText });
            const saveBtnElm = (0, domUtilities_1.createDomElement)('button', { className: 'btn btn-save btn-primary btn-xs', textContent: saveText });
