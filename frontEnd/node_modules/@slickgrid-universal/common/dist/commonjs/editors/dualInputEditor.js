...
class DualInputEditor {
    ...
    createInput(position) {
        ...
        input.setAttribute('aria-label', (_g = (_f = this.columnEditor) === null || _f === void 0 ? void 0 : _f.ariaLabel) !== null && _g !== void 0 ? _g : `${(0, utils_1.toSentenceCase)(columnId + '')} Input Editor`);
