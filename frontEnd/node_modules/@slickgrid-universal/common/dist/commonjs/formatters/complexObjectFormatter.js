...
exports.complexObjectFormatter = void 0;
/**
 ...
 */
const complexObjectFormatter = (_row, _cell, cellValue, columnDef, dataContext) => {
    var _a, _b, _c;
    if (!columnDef) {
        return '';
    }
...
exports.complexObjectFormatter = complexObjectFormatter;
