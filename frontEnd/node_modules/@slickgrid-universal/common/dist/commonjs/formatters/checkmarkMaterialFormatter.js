...
exports.checkmarkMaterialFormatter = void 0;
 ...
 */
const checkmarkMaterialFormatter = (_row, _cell, value) => {
    let isChecked = false;
    const isValidNumber = (0, utils_1.isNumber)(value);
    if (isValidNumber) {
...
exports.checkmarkMaterialFormatter = checkmarkMaterialFormatter;
//# sourceMappingURL=checkmarkMaterialFormatter.js.map