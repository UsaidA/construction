...
exports.translateBooleanFormatter = void 0;
/** Takes a boolean value, cast it to upperCase string and finally translates it (i18n). */
const translateBooleanFormatter = (_row, _cell, value, columnDef, _dataContext, grid) => {
    ...
    return value ? translater.translate(value.toUpperCase()) : '';
};
exports.translateBooleanFormatter = translateBooleanFormatter;
