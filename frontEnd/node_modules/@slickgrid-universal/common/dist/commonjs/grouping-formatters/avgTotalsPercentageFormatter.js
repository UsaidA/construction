...
const avgTotalsPercentageFormatter = (totals, columnDef, grid) => {
    ...
    const { minDecimal, maxDecimal, decimalSeparator, thousandSeparator, wrapNegativeNumber } = (0, formatterUtilities_1.retrieveFormatterOptions)(columnDef, grid, 'percent', 'group');
