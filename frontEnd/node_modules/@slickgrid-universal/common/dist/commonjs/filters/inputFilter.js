...
class InputFilter {
    ...
    setValues(values, operator) {
        ...
        if (operator && this._selectOperatorElm) {
            const operatorShorthand = (0, services_1.mapOperatorToShorthandDesignation)(this.operator);
    ...
    getCompoundOperatorOptionValues() {
        var _a;
        const type = (this.columnDef.type && this.columnDef.type) ? this.columnDef.type : index_1.FieldType.string;
        let optionValues = [];
        if ((_a = this.columnFilter) === null || _a === void 0 ? void 0 : _a.compoundOperatorList) {
            ...
            switch (type) {
                ...
                case index_1.FieldType.password:
                    optionValues = (0, filterUtilities_1.compoundOperatorString)(this.gridOptions, this.translaterService);
                    break;
                default:
                    optionValues = (0, filterUtilities_1.compoundOperatorNumeric)(this.gridOptions, this.translaterService);
                    break;
            }
        }
        return optionValues;
    ...
    createDomFilterElement(searchTerm) {
        ...
        (0, services_1.emptyElement)(this._cellContainerElm);
        ...
        this._filterInputElm = (0, services_1.createDomElement)('input', {
            type: this._inputType || 'text',
            autocomplete: 'none', placeholder,
            ariaLabel: (_g = (_f = this.columnFilter) === null || _f === void 0 ? void 0 : _f.ariaLabel) !== null && _g !== void 0 ? _g : `${(0, utils_1.toSentenceCase)(columnId + '')} Search Filter`,
        ...
        if (this.inputFilterType === 'single') {
            ...
            this._selectOperatorElm = (0, filterUtilities_1.buildSelectOperator)(this.getCompoundOperatorOptionValues(), this.gridOptions);
            this._filterContainerElm = (0, services_1.createDomElement)('div', { className: `form-group search-filter filter-${columnId}` });
            const containerInputGroupElm = (0, services_1.createDomElement)('div', { className: 'input-group' });
            const operatorInputGroupAddonElm = (0, services_1.createDomElement)('div', { className: 'input-group-addon input-group-prepend operator' });
            ...
            containerInputGroupElm.appendChild((0, services_1.createDomElement)('span'));
            // create the DOM element & add an ID and filter class
            this._filterContainerElm.appendChild(containerInputGroupElm);
            if (this.operator) {
                this._selectOperatorElm.value = (0, services_1.mapOperatorToShorthandDesignation)(this.operator);
            }
