...
class SelectFilter {
    ...
    init(args) {
        ...
        this._locales = (_d = (_c = this.gridOptions) === null || _c === void 0 ? void 0 : _c.locales) !== null && _d !== void 0 ? _d : constants_1.Constants.locales;
    ...
    renderDomElement(inputCollection) {
        ...
        const selectBuildResult = (0, index_2.buildSelectEditorOrFilterDomElement)('filter', newCollection, this.columnDef, this.grid, this.isMultipleSelect, this.translaterService, this.searchTerms || []);
