...
class SlickCellRangeSelector {
    ...
    init(grid) {
        this._grid = grid;
        this._decorator = this._addonOptions.cellDecorator || new index_1.SlickCellRangeDecorator(grid, this._addonOptions);
    ...
    dispose() {
        ...
        (0, domUtilities_1.emptyElement)(this._activeCanvas);
        (0, domUtilities_1.emptyElement)(this._canvas);
    ...
    getMouseOffsetViewport(e, dd) {
        ...
        const viewportOffset = (0, domUtilities_1.getHtmlElementOffset)(this._activeViewport);
    ...
    handleDragTo(e, dd) {
        ...
        const targetEvent = (_b = (_a = e === null || e === void 0 ? void 0 : e.touches) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : e;
        const end = this._grid.getCellFromPoint(targetEvent.pageX - ((_d = (_c = (0, domUtilities_1.getHtmlElementOffset)(this._activeCanvas)) === null || _c === void 0 ? void 0 : _c.left) !== null && _d !== void 0 ? _d : 0) + this._columnOffset, targetEvent.pageY - ((_g = (_f = (0, domUtilities_1.getHtmlElementOffset)(this._activeCanvas)) === null || _f === void 0 ? void 0 : _f.top) !== null && _g !== void 0 ? _g : 0) + this._rowOffset);
        if (end !== undefined) {
            // ... frozen column(s),
    ...
    handleDragStart(e, dd) {
        ...
        this._grid.focus();
        let startX = dd.startX - ((_b = (_a = (0, domUtilities_1.getHtmlElementOffset)(this._canvas)) === null || _a === void 0 ? void 0 : _a.left) !== null && _b !== void 0 ? _b : 0);
        if (this._gridOptions.frozenColumn >= 0 && this._isRightCanvas) {
            startX += this._scrollLeft;
        }
        let startY = dd.startY - ((_d = (_c = (0, domUtilities_1.getHtmlElementOffset)(this._canvas)) === null || _c === void 0 ? void 0 : _c.top) !== null && _d !== void 0 ? _d : 0);
