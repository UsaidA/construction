...
exports.updateColumnPickerOrder = exports.populateColumnPicker = exports.handleColumnPickerItemClick = exports.addColumnTitleElementWhenDefined = exports.addCloseButtomElement = void 0;
/* eslint-disable @typescript-eslint/no-this-alias */
const utils_1 = require("@slickgrid-universal/utils");
const domUtilities_1 = require("../services/domUtilities");
const slickColumnPicker_1 = require("./slickColumnPicker");
const slickGridMenu_1 = require("./slickGridMenu");
/** Create a Close button element and add it to the Menu element */
function addCloseButtomElement(menuElm) {
    const context = this;
    const closePickerButtonElm = (0, domUtilities_1.createDomElement)('button', {
        type: 'button', className: 'close',
        innerHTML: '&times;',
        dataset: { dismiss: context instanceof slickColumnPicker_1.SlickColumnPicker ? 'slick-column-picker' : 'slick-grid-menu' }
    });
    closePickerButtonElm.setAttribute('aria-label', 'Close');
    menuElm.appendChild(closePickerButtonElm);
}
exports.addCloseButtomElement = addCloseButtomElement;
/** When "columnTitle" option is provided, let's create a div element to show "Columns" list title */
function addColumnTitleElementWhenDefined(menuElm) {
    var _a, _b, _c;
    const context = this;
    if ((_a = context.addonOptions) === null || _a === void 0 ? void 0 : _a.columnTitle) {
        context._columnTitleElm = (0, domUtilities_1.createDomElement)('div', { className: 'slick-menu-title', textContent: (_c = (_b = context.addonOptions) === null || _b === void 0 ? void 0 : _b.columnTitle) !== null && _c !== void 0 ? _c : context._defaults.columnTitle });
        menuElm.appendChild(context._columnTitleElm);
    }
}
exports.addColumnTitleElementWhenDefined = addColumnTitleElementWhenDefined;
/**
 ...
 * @returns
 */
function handleColumnPickerItemClick(event) {
    var _a, _b;
    const context = this;
    const controlType = context instanceof slickColumnPicker_1.SlickColumnPicker ? 'columnPicker' : 'gridMenu';
    ...
    if (event.target.type === 'checkbox') {
        ...
        context._columnCheckboxes.forEach((columnCheckbox, idx) => {
        ...
        const frozenColumnIndex = (_a = context.gridOptions.frozenColumn) !== null && _a !== void 0 ? _a : -1;
        ...
        context.pubSubService.publish(`on${(0, utils_1.titleCase)(controlType)}ColumnsChanged`, callbackArgs);
        if (typeof ((_b = context.addonOptions) === null || _b === void 0 ? void 0 : _b.onColumnsChanged) === 'function') {
            context.addonOptions.onColumnsChanged(event, callbackArgs);
        }
        context.onColumnsChanged.notify(callbackArgs, null, context);
    }
}
exports.handleColumnPickerItemClick = handleColumnPickerItemClick;
function populateColumnPicker(addonOptions) {
    var _a, _b;
    const context = this;
    const menuPrefix = context instanceof slickGridMenu_1.SlickGridMenu ? 'gridmenu-' : '';
    for (const column of context.columns) {
        ...
        const colInputElm = (0, domUtilities_1.createDomElement)('input', {
        ...
        const headerColumnValueExtractorFn = typeof (addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.headerColumnValueExtractor) === 'function' ? addonOptions.headerColumnValueExtractor : context._defaults.headerColumnValueExtractor;
        const columnLabel = headerColumnValueExtractorFn(column, context.gridOptions);
        columnLiElm.appendChild((0, domUtilities_1.createDomElement)('label', {
            htmlFor: `${context._gridUid}-${menuPrefix}colpicker-${columnId}`,
            innerHTML: (0, domUtilities_1.sanitizeTextByAvailableSanitizer)(context.gridOptions, columnLabel),
        }));
    ...
    if (!(addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.hideForceFitButton)) {
        const fitLiElm = document.createElement('li');
        fitLiElm.appendChild((0, domUtilities_1.createDomElement)('input', {
        ...
        fitLiElm.appendChild((0, domUtilities_1.createDomElement)('label', {
            htmlFor: `${context._gridUid}-${menuPrefix}colpicker-forcefit`,
            textContent: (_a = addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.forceFitTitle) !== null && _a !== void 0 ? _a : '',
        }));
        context._listElm.appendChild(fitLiElm);
    }
    if (!(addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.hideSyncResizeButton)) {
        const syncLiElm = document.createElement('li');
        syncLiElm.appendChild((0, domUtilities_1.createDomElement)('input', {
        ...
        syncLiElm.appendChild((0, domUtilities_1.createDomElement)('label', {
            htmlFor: `${context._gridUid}-${menuPrefix}colpicker-syncresize`,
            textContent: (_b = addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.syncResizeTitle) !== null && _b !== void 0 ? _b : ''
        }));
        context._listElm.appendChild(syncLiElm);
    }
}
exports.populateColumnPicker = populateColumnPicker;
/**
 ...
 */
function updateColumnPickerOrder() {
    const context = this;
...
exports.updateColumnPickerOrder = updateColumnPickerOrder;
//# sourceMappingURL=extensionCommonUtils.js.map