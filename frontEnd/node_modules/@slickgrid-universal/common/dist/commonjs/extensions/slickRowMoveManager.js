...
class SlickRowMoveManager {
    ...
    constructor(pubSubService) {
        ...
        this.onBeforeMoveRows = new Slick.Event();
        this.onMoveRows = new Slick.Event();
        this.pluginName = 'RowMoveManager';
    ...
    init(grid, options) {
        ...
        if (typeof ((_a = this._addonOptions) === null || _a === void 0 ? void 0 : _a.usabilityOverride) === 'function') {
    ...
    create(columnDefinitions, gridOptions) {
        var _a, _b;
        this._addonOptions = { ...this._defaults, ...gridOptions.rowMoveManager };
        if (Array.isArray(columnDefinitions) && gridOptions) {
            const newRowMoveColumn = this.getColumnDefinition();
            // add new row move column unless it was already added
            if (!columnDefinitions.some(col => col.id === newRowMoveColumn.id)) {
                const rowMoveColDef = Array.isArray(columnDefinitions) && columnDefinitions.find((col) => (col === null || col === void 0 ? void 0 : col.behavior) === 'selectAndMove');
                const finalRowMoveColumn = rowMoveColDef ? rowMoveColDef : newRowMoveColumn;
                // column index position in the grid
                const columnPosition = (_b = (_a = gridOptions === null || gridOptions === void 0 ? void 0 : gridOptions.rowMoveManager) === null || _a === void 0 ? void 0 : _a.columnIndexPosition) !== null && _b !== void 0 ? _b : 0;
                if (columnPosition > 0) {
    ...
    handleDrag(e, dd) {
        ...
        if (this._dragging) {
            ...
            const top = targetEvent.pageY - ((_d = (_c = (0, domUtilities_1.getHtmlElementOffset)(this._canvas)) === null || _c === void 0 ? void 0 : _c.top) !== null && _d !== void 0 ? _d : 0);
            ...
            if (insertBefore !== dd.insertBefore) {
                ...
                if (((_f = (_e = this._addonOptions) === null || _e === void 0 ? void 0 : _e.onBeforeMoveRows) === null || _f === void 0 ? void 0 : _f.call(_e, e, eventData)) === false || this.onBeforeMoveRows.notify(eventData) === false) {
                    dd.canMove = false;
                }
                else {
                    dd.canMove = true;
    ...
    handleDragStart(event, dd) {
        ...
        if (this.checkUsabilityOverride(currentRow, dataContext, this._grid)) {
            ...
            if (!this.addonOptions.hideRowMoveShadow) {
                const slickRowElm = (_a = this._grid.getCellNode(cell.row, cell.cell)) === null || _a === void 0 ? void 0 : _a.closest('.slick-row');
                if (slickRowElm) {
                    ...
                    dd.clonedSlickRow.style.marginLeft = (0, domUtilities_1.findWidthOrDefault)((_b = this._addonOptions) === null || _b === void 0 ? void 0 : _b.rowMoveShadowMarginLeft, '0px');
                    dd.clonedSlickRow.style.marginTop = (0, domUtilities_1.findWidthOrDefault)((_c = this._addonOptions) === null || _c === void 0 ? void 0 : _c.rowMoveShadowMarginTop, '0px');
                    dd.clonedSlickRow.style.opacity = `${(_e = (_d = this._addonOptions) === null || _d === void 0 ? void 0 : _d.rowMoveShadowOpacity) !== null && _e !== void 0 ? _e : 0.95}`;
                    dd.clonedSlickRow.style.transform = `scale(${(_g = (_f = this.addonOptions) === null || _f === void 0 ? void 0 : _f.rowMoveShadowScale) !== null && _g !== void 0 ? _g : 0.75})`;
            ...
            dd.selectionProxy = (0, domUtilities_1.createDomElement)('div', {
            ...
            dd.guide = (0, domUtilities_1.createDomElement)('div', {
    ...
    moveIconFormatter(row, cell, value, column, dataContext, grid) {
...
//# sourceMappingURL=slickRowMoveManager.js.map