 ...
 *   }];
 */
class SlickCellMenu extends menuFromCellBaseClass_1.MenuFromCellBaseClass {
    ...
    translateCellMenu() {
        ...
        if ((gridOptions === null || gridOptions === void 0 ? void 0 : gridOptions.enableTranslate) && Array.isArray(columnDefinitions)) {
            columnDefinitions.forEach((columnDef) => {
                if ((columnDef === null || columnDef === void 0 ? void 0 : columnDef.cellMenu) && (Array.isArray(columnDef.cellMenu.commandItems) || Array.isArray(columnDef.cellMenu.optionItems))) {
                    // get both items list
    ...
    sortMenuItems(columnDefinitions) {
        ...
        columnDefinitions.forEach((columnDef) => {
            var _a, _b;
            if ((_a = columnDef === null || columnDef === void 0 ? void 0 : columnDef.cellMenu) === null || _a === void 0 ? void 0 : _a.commandItems) {
                this.extensionUtility.sortItems(columnDef.cellMenu.commandItems || [], 'positionOrder');
            }
            if ((_b = columnDef === null || columnDef === void 0 ? void 0 : columnDef.cellMenu) === null || _b === void 0 ? void 0 : _b.optionItems) {
...
//# sourceMappingURL=slickCellMenu.js.map