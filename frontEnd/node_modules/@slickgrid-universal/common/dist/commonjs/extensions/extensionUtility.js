...
exports.ExtensionUtility = void 0;
...
class ExtensionUtility {
    ...
    getPickerTitleOutputString(propName, pickerName) {
        ...
        const locales = (_f = (_e = this.sharedService.gridOptions) === null || _e === void 0 ? void 0 : _e.locales) !== null && _f !== void 0 ? _f : constants_1.Constants.locales;
    ...
    translateWhenEnabledAndServiceExist(translationKey, localeKey, textToUse) {
        ...
        const locales = (_b = gridOptions === null || gridOptions === void 0 ? void 0 : gridOptions.locales) !== null && _b !== void 0 ? _b : constants_1.Constants.locales;
        if (textToUse) {
            text = textToUse;
        }
