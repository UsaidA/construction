...
export class CheckboxEditor {
    ...
    init() {
        ...
        this._input.setAttribute('aria-label', (_f = (_e = this.columnEditor) === null || _e === void 0 ? void 0 : _e.ariaLabel) !== null && _f !== void 0 ? _f : `${toSentenceCase(columnId + '')} Checkbox Editor`);
