...
export class LongTextEditor {
    ...
    init() {
        ...
        this._textareaElm.setAttribute('aria-label', (_0 = (_z = this.columnEditor) === null || _z === void 0 ? void 0 : _z.ariaLabel) !== null && _0 !== void 0 ? _0 : `${toSentenceCase(columnId + '')} Text Editor`);
