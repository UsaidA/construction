...
export class SlickRowMoveManager {
    ...
    handleDrag(e, dd) {
        ...
        if (this._dragging) {
            ...
            const top = targetEvent.pageY - ((_d = (_c = getHtmlElementOffset(this._canvas)) === null || _c === void 0 ? void 0 : _c.top) !== null && _d !== void 0 ? _d : 0);
        ...
        if (this.checkUsabilityOverride(currentRow, dataContext, this._grid)) {
            ...
            if (!this.addonOptions.hideRowMoveShadow) {
                ...
                if (slickRowElm) {
                    ...
                    dd.clonedSlickRow.style.marginLeft = findWidthOrDefault((_b = this._addonOptions) === null || _b === void 0 ? void 0 : _b.rowMoveShadowMarginLeft, '0px');
                    dd.clonedSlickRow.style.marginTop = findWidthOrDefault((_c = this._addonOptions) === null || _c === void 0 ? void 0 : _c.rowMoveShadowMarginTop, '0px');
