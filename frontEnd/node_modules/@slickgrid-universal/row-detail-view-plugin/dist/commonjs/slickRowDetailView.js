...
class SlickRowDetailView {
    ...
    init(grid) {
        ...
        if (!this._addonOptions) {
            this._addonOptions = (0, utils_1.objectAssignAndExtend)(this.gridOptions.rowDetailView, this._defaults);
        }
    ...
    create(columnDefinitions, gridOptions) {
        ...
        this._addonOptions = (0, utils_1.objectAssignAndExtend)(gridOptions.rowDetailView, this._defaults);
    ...
    setOptions(options) {
        var _a;
        this._addonOptions = (0, utils_1.objectAssignAndExtend)(options, this._addonOptions);
