...
class TranslaterService {
    ...
    use(newLang) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return (_b = (_a = this.translateService) === null || _a === void 0 ? void 0 : _a.use) === null || _b === void 0 ? void 0 : _b.call(_a, newLang);
        });
    }
    /**
...
class AngularSlickgridComponent {
    constructor(angularUtilService, appRef, cd, containerService, elm, translate, translaterService, forRootConfig, externalServices) {
        ...
        this.backendUtilityService = (_b = externalServices === null || externalServices === void 0 ? void 0 : externalServices.backendUtilityService) !== null && _b !== void 0 ? _b : new BackendUtilityService();
    ...
    initialization(eventHandler) {
        ...
        this._eventPubSubService.eventNamingStyle = (_b = (_a = this.gridOptions) === null || _a === void 0 ? void 0 : _a.eventNamingStyle) !== null && _b !== void 0 ? _b : EventNamingStyle.camelCase;
    ...
    bindDifferentHooks(grid, gridOptions, dataView) {
        ...
        if (dataView && grid) {
            const slickgridEventPrefix = (_d = (_c = this.gridOptions) === null || _c === void 0 ? void 0 : _c.defaultSlickgridEventPrefix) !== null && _d !== void 0 ? _d : '';
    ...
    swapInternalEditorToSlickGridFactoryEditor(columnDefinitions) {
        ...
        return columnDefinitions.map((column) => {
            ...
            if ((_a = column === null || column === void 0 ? void 0 : column.editor) === null || _a === void 0 ? void 0 : _a.collectionAsync) {
